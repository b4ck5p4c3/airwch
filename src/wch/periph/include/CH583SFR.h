...
// multi-blocks: __BASE_TYPE__, __CH583SFR_H__, __CH583USBSFR_H__,
// __USB_TYPE__...
...
//
//    SFR:    40000000H - 4000FFFFH,  64KB
//      SYS:     +1000H - 1BFFH, include base configuration, interrupt, GPIO,
//      etc... TMR0:    +2000H - 23FFH TMR1:    +2400H - 27FFH TMR2:    +2800H -
//      2BFFH TMR3:    +2C00H - 2FFFH UART0:   +3000H - 33FFH UART1:   +3400H -
//      37FFH UART2:   +3800H - 3BFFH UART3:   +3C00H - 3FFFH SPI0:    +4000H -
//      43FFH SPI1:    +4400H - 47FFH I2C:     +4800H - 4BFFH PWMx:    +5000H -
//      53FFH USB:     +8000H - 83FFH USB2:    +8400H - 87FFH BLE:     +C000H -
//      D3FFH
...
#define R8_CHIP_ID                                                             \
  (*((PUINT8V)0x40001041)) // RF, chip ID register, always is ID_CH58*
...
#define RB_ROM_CODE_OFS                                                        \
  0x10 // RWA, code offset address selection in Flash ROM: 0=start address
       // 0x000000, 1=start address 0x040000
#define RB_ROM_CTRL_EN                                                         \
  0x20 // RWA, enable flash ROM control interface enable: 0=disable access,
       // 1=enable access control register
#define RB_ROM_DATA_WE                                                         \
  0x40 // RWA, enable flash ROM data & code area being erase/write: 0=all
       // writing protect, 1=enable data area program and erase
#define RB_ROM_CODE_WE                                                         \
  0x80 // RWA, enable flash ROM code area being erase/write: 0=code writing
       // protect, 1=enable code area program and erase
#define R8_GLOB_CFG_INFO                                                       \
  (*((PUINT8V)0x40001045)) // RO, global configuration information and status
#define RB_CFG_ROM_READ                                                        \
  0x01 // RO, indicate protected status of Flash ROM code and data: 0=reading
...
#define R16_CLK_SYS_CFG                                                        \
  (*((PUINT16V)0x40001008)) // RWA, system clock configuration, SAM
#define RB_CLK_PLL_DIV 0x1F // RWA, output clock divider from PLL or CK32M
#define RB_CLK_SYS_MOD                                                         \
  0xC0 // RWA, system clock source mode: 00=divided from 32MHz, 01=divided from
       // PLL-480MHz, 10=directly from 32MHz, 11=directly from 32KHz
#define R8_HFCK_PWR_CTRL                                                       \
  (*((PUINT8V)0x4000100A)) // RWA, high frequency clock module power control,
                           // SAM
#define RB_CLK_XT32M_PON                                                       \
  0x04 // RWA, external 32MHz oscillator power control: 0=power down, 1-power on
#define RB_CLK_XT32M_KEEP                                                      \
  0x08 // RWA, external 32MHz oscillator power keep under halt mode: 0=auto
       // stop, 1=keep running
...
// Fsys = RB_CLK_SYS_MOD==3 ? Fck32k : ( ( RB_CLK_SYS_MOD[0] ? Fpll : XT_32MHz )
...
// #define  RB_SLP_BLE_WAKE    0x04                      // RWA, enable BLE
// waking
...
// #define  RB_SLP_USB_PWR_DN  0x01                      // RWA, enable USB
// power down #define  RB_SLP_BLE_PWR_DN  0x04                      // RWA,
// enable BLE power down
...
#define RB_RAM_RET_LV                                                          \
  0x40 // RWA, SRAM retention voltage selection: 0=normal, 1=low voltage for low
       // power
...
#define R16_PIN_ALTERNATE                                                      \
  (*((PUINT16V)0x40001018)) // RW, function pin alternate configuration
#define RB_PIN_TMR0                                                            \
  0x01 // RW, TMR0 alternate pin enable: 0=TMR0/PWM0/CAP0 on PA[9],
       // 1=TMR0_/PWM0_/CAP0_ on PB[23]
#define RB_PIN_TMR1                                                            \
  0x02 // RW, TMR1 alternate pin enable: 0=TMR1/PWM1/CAP1 on PA[10],
       // 1=TMR1_/PWM1_/CAP1_ on PB[10]
#define RB_PIN_TMR2                                                            \
  0x04 // RW, TMR2 alternate pin enable: 0=TMR2/PWM2/CAP2 on PA[11],
       // 1=TMR2_/PWM2_/CAP2_ on PB[11]
#define RB_PIN_TMR3                                                            \
  0x08 // RW, TMR3 alternate pin enable: 0=TMR3/PWM3/CAP3 on PA[2],
       // 1=TMR3_/PWM3_/CAP3_ on PB[22]
#define RB_PIN_UART0                                                           \
  0x10 // RW, RXD0/TXD0 alternate pin enable: 0=RXD0/TXD0 on PB[4]/PB[7],
       // 1=RXD0_/TXD0_ on PA[15]/PA[14]
#define RB_PIN_UART1                                                           \
  0x20 // RW, RXD1/TXD1 alternate pin enable: 0=RXD1/TXD1 on PA[8]/PA[9],
       // 1=RXD1_/TXD1_ on PB[12]/PB[13]
#define RB_PIN_UART2                                                           \
  0x40 // RW, RXD2/TXD2 alternate pin enable: 0=RXD2/TXD2 on PA[6]/PA[7],
       // 1=RXD2_/TXD2_ on PB[22]/PB[23]
#define RB_PIN_UART3                                                           \
  0x80 // RW, RXD3/TXD3 alternate pin enable: 0=RXD3/TXD3 on PA[4]/PA[5],
       // 1=RXD3_/TXD3_ on PB[20]/PB[21]
#define RB_PIN_SPI0                                                            \
  0x100 // RW, SCS/SCK0/MOSI/MISO alternate pin enable: 0=SCS/SCK0/MOSI/MISO on
        // PA[12]/PA[13]/PA[14]/PA[15], 1=SCS_/SCK0_/MOSI_/MISO_ on
        // PB[12]/PB[13]/PB[14]/PB[15]
#define RB_PIN_PWMX                                                            \
  0x400 // RW, PWM4/PWM5/PWM7/PWM8/PWM9 alternate pin enable: 0=PWM4/5/7/8/9 on
        // PA[12]/PA[13]/PB[4]/PB[6]/PB[7], 1=PWM4/5/7/8/9 on
        // PA[6]/PA[7]/PB[1]/PB[2]/P[3]
#define RB_PIN_I2C                                                             \
  0x800 // RW, SCL/SDA alternate pin enable: 0=SCL/SDA on PB[13]/PB[12],
        // 1=SCL_/SDA_ on PB[21]/PB[20]
#define RB_PIN_MODEM                                                           \
  0x1000 // RW, DSR/DTR alternate pin enable: 0=DSR/DTR on PB[1]/PB[5],
         // 1=DSR_/DTR_ on PB[14]/PB[15]
#define RB_PIN_INTX                                                            \
  0x2000 // RW, interrupt INT24/INT25 alternate pin enable: 0=INT24/INT25 on
         // PB[8]/PB[9], 1=INT24_/INT25_ on PB[22]/PB[23]
#define RB_PIN_U0_INV                                                          \
  0x4000 // RW, RXD0/RXD0_/TXD0/TXD0_ invert input/output enable: 0=normal
         // input/output, 1=RXD invert input, TXD invert output
#define RB_RF_ANT_SW_EN                                                        \
  0x8000 // RW, RF antenna switch control output enable: 0=disable output,
         // 1=output on PB[16]/PB[17]/PB[18]/PB[19]/PB[20]/PB[21]
#define R16_PIN_ANALOG_IE                                                      \
  (*((PUINT16V)0x4000101A)) // RW, analog pin enable and digital input disable
#define RB_PIN_ADC8_9_IE                                                       \
  0x01 // RW, ADC/TouchKey channel 9/8 digital input disable: 0=digital input
       // enable, 1=digital input disable
#define RB_PIN_ADC6_7_IE                                                       \
  0x02 // RW, ADC/TouchKey channel 7/6 digital input disable: 0=digital input
       // enable, 1=digital input disable
#define RB_PIN_ADC10_IE                                                        \
  0x04 // RW, ADC/TouchKey channel 10 digital input disable: 0=digital input
       // enable, 1=digital input disable
#define RB_PIN_ADC11_IE                                                        \
  0x08 // RW, ADC/TouchKey channel 11 digital input disable: 0=digital input
       // enable, 1=digital input disable
#define RB_PIN_USB2_DP_PU                                                      \
  0x10 // RW, USB2 UDP internal pullup resistance enable: 0=enable/disable by
       // RB_UC_DEV_PU_EN, 1=enable pullup, replace RB_UC_DEV_PU_EN under sleep
       // mode
#define RB_PIN_USB2_IE                                                         \
  0x20 // RW, USB2 analog I/O enable: 0=analog I/O disable, 1=analog I/O enable
#define RB_PIN_USB_DP_PU                                                       \
  0x40 // RW, USB UDP internal pullup resistance enable: 0=enable/disable by
       // RB_UC_DEV_PU_EN, 1=enable pullup, replace RB_UC_DEV_PU_EN under sleep
       // mode
#define RB_PIN_USB_IE                                                          \
  0x80 // RW, USB analog I/O enable: 0=analog I/O disable, 1=analog I/O enable
#define RB_PIN_ADC0_IE                                                         \
  0x0200 // RW, ADC/TouchKey channel 0 digital input disable: 0=digital input
         // enable, 1=digital input disable
#define RB_PIN_ADC1_IE                                                         \
  0x0400 // RW, ADC/TouchKey channel 1 digital input disable: 0=digital input
         // enable, 1=digital input disable
#define RB_PIN_ADC12_IE                                                        \
  0x0800 // RW, ADC/TouchKey channel 12 digital input disable: 0=digital input
         // enable, 1=digital input disable
#define RB_PIN_ADC13_IE                                                        \
  0x1000 // RW, ADC/TouchKey channel 13 digital input disable: 0=digital input
         // enable, 1=digital input disable
#define RB_PIN_XT32K_IE                                                        \
  0x2000 // RW, external 32KHz oscillator digital input disable: 0=digital input
         // enable, 1=digital input disable
#define RB_PIN_ADC2_3_IE                                                       \
  0x4000 // RW, ADC/TouchKey channel 2/3 digital input disable: 0=digital input
         // enable, 1=digital input disable
#define RB_PIN_ADC4_5_IE                                                       \
  0x8000 // RW, ADC/TouchKey channel 4/5 digital input disable: 0=digital input
         // enable, 1=digital input disable
...
#define RB_PWR_DCDC_EN                                                         \
  0x0200 // RWA, DC/DC converter enable: 0=DC/DC disable and bypass, 1=DC/DC
         // enable
...
#define R16_AUX_POWER_ADJ                                                      \
  (*((PUINT8V)0x40001022))    // RWA, aux power adjust control, SAM
...
#define RB_BAT_DET_EN                                                          \
  0x01 // RWA, battery voltage detector enable if RB_BAT_MON_EN=0
#define RB_BAT_LOW_VTHX                                                        \
  0x01 // RWA, select monitor threshold voltage if RB_BAT_MON_EN=1
...
#define RB_BAT_STAT_LOWER                                                      \
  0x01 // RO, battery lower voltage status for detector, high action
...
#define R32_OSC32K_CTRL                                                        \
  (*((PUINT32V)0x4000102C)) // RWA, 32KHz oscillator control, SAM
#define R16_INT32K_TUNE                                                        \
  (*((PUINT16V)0x4000102C)) // RWA, internal 32KHz oscillator tune control, SAM
#define RB_INT32K_TUNE 0x1FFF // RWA, internal 32KHz oscillator frequency tune
#define R8_XT32K_TUNE                                                          \
  (*((PUINT8V)0x4000102E)) // RWA, external 32KHz oscillator tune control, SAM
#define RB_XT32K_I_TUNE                                                        \
  0x03 // RWA, external 32KHz oscillator current tune: 00=75% current,
       // 01=standard current, 10=150% current, 11=200% current for startup
#define RB_XT32K_C_LOAD                                                        \
  0xF0 // RWA, external 32KHz oscillator load capacitor tune: Cap =
       // RB_XT32K_C_LOAD + 12pF
#define R8_CK32K_CONFIG                                                        \
  (*((PUINT8V)0x4000102F))     // RWA, 32KHz oscillator configure
...
#define RB_CLK_OSC32K_XT                                                       \
  0x04 // RWA, 32KHz oscillator source selection: 0=RC, 1=XT
#define RB_CLK_OSC32K_FILT                                                     \
  0x08 // RWA, internal 32KHz oscillator low noise mode disable: 0=enable,
       // 1=disable
...
#define RB_RTC_TMR_MODE                                                        \
  0x07 // RWA, RTC timer mode: 000=0.125S, 001=0.25S, 010=0.5S, 011=1S, 100=2S,
       // 101=4S, 110=8S, 111=16S
...
#define RB_RTC_LOAD_LO                                                         \
  0x40 // RWA, set 1 to load RTC count low word R32_RTC_CNT_32K, auto clear
       // after loaded
...
#define R32_RTC_CNT_DAY                                                        \
  (*((PUINT32V)0x4000103C)) // RO, RTC count based one day, only low 14 bit
...
#define R32_OSC32M_CTRL                                                        \
  (*((PUINT32V)0x4000104C)) // RWA, 32MHz oscillator control, SAM
...
#define R16_OSC_CAL_CNT                                                        \
  (*((PUINT16V)0x40001050)) // RO, system clock count value for 32KHz
                            // multi-cycles
#define RB_OSC_CAL_CNT                                                         \
  0x3FFF // RO, system clock count value for 32KHz multi-cycles
...
#define R8_ADC_CHANNEL                                                         \
  (*((PUINT8V)0x40001058))                  // RW, ADC input channel selection
...
#define RB_ADC_DIFF_EN                                                         \
  0x04 // RW, ADC input channel mode: 0=single-end, 1=differnetial
#define RB_ADC_OFS_TEST                                                        \
  0x08 // RW, enable ADC offset test mode: 0=normal mode, 1=short to test offset
#define RB_ADC_PGA_GAIN                                                        \
  0x30 // RW, set ADC input PGA gain: 00=-12dB, 01=-6dB, 10=0dB, 11=6dB
#define RB_ADC_CLK_DIV                                                         \
  0xC0 // RW, select ADC clock frequency: 00=3.2MHz, 01=8MHz, 10=5.33MHz,
       // 11=4MHz
#define R8_ADC_CONVERT (*((PUINT8V)0x4000105A)) // RW, ADC convert control
#define RB_ADC_START                                                           \
  0x01 // RW, ADC convert start control: 0=stop ADC convert, 1=start an ADC
       // convert, auto clear
...
#define RB_TEM_SEN_PWR_ON                                                      \
  0x80 // RW, temperature sensor power control: 0=power down, 1=power on
...
#define R8_ADC_INT_FLAG                                                        \
  (*((PUINT8V)0x4000105E)) // RO, ADC interrupt flag register
#define RB_ADC_IF_EOC                                                          \
  0x80 // RO, ADC conversion interrupt flag: 0=free or converting, 1=end of
       // conversion, interrupt action, auto ADC or write R8_ADC_CONVERT or
       // write R8_TKEY_CONVERT to clear flag
#define R32_TKEY_CTRL (*((PUINT8V)0x40001054)) // RW, Touchkey control
#define R8_TKEY_COUNT                                                          \
  (*((PUINT8V)0x40001054))     // RW, Touchkey charge and discharge count
...
#define RB_TKEY_START                                                          \
  0x01 // RW, Touchkey convert start control: 0=stop Touchkey convert, 1=start a
       // Touchkey convert, auto clear
...
#define RB_TKEY_CURRENT                                                        \
  0x02 // RW, Touchkey charge current selection: 0=35uA, 1=70uA
#define RB_TKEY_DRV_EN 0x04 // RW, Touchkey drive shield enable
#define RB_TKEY_PGA_ADJ                                                        \
  0x08 // RW, ADC input PGA speed selection: 0=slow, 1=fast
...
#define RB_ADC_IF_END_ADC                                                      \
  0x10 // RW1, interrupt flag for end of ADC conversion, DMA for auto ADC or
       // write R8_ADC_CONVERT to clear flag
#define R8_ADC_AUTO_CYCLE                                                      \
  (*((PUINT8V)0x40001063)) // RW, auto ADC cycle value, unit is 16 Fsys
...
#define R16_PB_INT_MODE                                                        \
  (*((PUINT16V)0x40001096)) // RW, GPIO PB interrupt mode: 0=level action,
                            // 1=edge action
...
/* GPIO PB register */
#define R32_PB_DIR                                                             \
  (*((PUINT32V)0x400010C0)) // RW, GPIO PB I/O direction: 0=in, 1=out
...
#define R32_PB_CLR                                                             \
  (*((PUINT32V)0x400010CC)) // WZ, GPIO PB clear output: 0=keep, 1=clear
...
#define R32_PB_PU                                                              \
  (*((PUINT32V)0x400010D0)) // RW, GPIO PB pullup resistance enable
#define R8_PB_PU_0                                                             \
  (*((PUINT8V)0x400010D0)) // RW, GPIO PB pullup resistance enable byte 0
#define R8_PB_PU_1                                                             \
  (*((PUINT8V)0x400010D1)) // RW, GPIO PB pullup resistance enable byte 1
#define R8_PB_PU_2                                                             \
  (*((PUINT8V)0x400010D2)) // RW, GPIO PB pullup resistance enable byte 2
#define R32_PB_PD_DRV                                                          \
  (*((PUINT32V)0x400010D4)) // RW, PB pulldown for input or PB driving
                            // capability for output
#define R8_PB_PD_DRV_0                                                         \
  (*((PUINT8V)0x400010D4)) // RW, PB pulldown for input or PB driving capability
                           // for output byte 0
#define R8_PB_PD_DRV_1                                                         \
  (*((PUINT8V)0x400010D5)) // RW, PB pulldown for input or PB driving capability
                           // for output byte 1
#define R8_PB_PD_DRV_2                                                         \
  (*((PUINT8V)0x400010D6)) // RW, PB pulldown for input or PB driving capability
                           // for output byte 2
...
#define R8_TMR0_FIFO_COUNT                                                     \
  (*((PUINT8V)0x40002007))                       // RO, TMR0 FIFO count status
...
#define R32_TMR0_CNT_END                                                       \
  (*((PUINT32V)0x4000200C)) // RW, TMR0 end count value, only low 26 bit
#define R32_TMR0_FIFO                                                          \
  (*((PUINT32V)0x40002010)) // RO/WO, TMR0 FIFO register, only low 26 bit
...
#define R8_TMR1_FIFO_COUNT                                                     \
  (*((PUINT8V)0x40002407))                       // RO, TMR1 FIFO count status
...
#define R32_TMR1_CNT_END                                                       \
  (*((PUINT32V)0x4000240C)) // RW, TMR1 end count value, only low 26 bit
#define R32_TMR1_FIFO                                                          \
  (*((PUINT32V)0x40002410)) // RO/WO, TMR1 FIFO register, only low 26 bit
...
#define R32_TMR1_DMA_NOW                                                       \
  (*((PUINT32V)0x40002414)) // RW, TMR1 DMA current address
#define R16_TMR1_DMA_NOW                                                       \
  (*((PUINT16V)0x40002414)) // RW, TMR1 DMA current address
...
#define R8_TMR2_FIFO_COUNT                                                     \
  (*((PUINT8V)0x40002807))                       // RO, TMR2 FIFO count status
...
#define R32_TMR2_CNT_END                                                       \
  (*((PUINT32V)0x4000280C)) // RW, TMR2 end count value, only low 26 bit
#define R32_TMR2_FIFO                                                          \
  (*((PUINT32V)0x40002810)) // RO/WO, TMR2 FIFO register, only low 26 bit
...
#define R32_TMR2_DMA_NOW                                                       \
  (*((PUINT32V)0x40002814)) // RW, TMR2 DMA current address
#define R16_TMR2_DMA_NOW                                                       \
  (*((PUINT16V)0x40002814)) // RW, TMR2 DMA current address
...
#define R8_TMR3_FIFO_COUNT                                                     \
  (*((PUINT8V)0x40002C07))                       // RO, TMR3 FIFO count status
...
#define R32_TMR3_CNT_END                                                       \
  (*((PUINT32V)0x40002C0C)) // RW, TMR3 end count value, only low 26 bit
#define R32_TMR3_FIFO                                                          \
  (*((PUINT32V)0x40002C10)) // RO/WO, TMR3 FIFO register, only low 26 bit
...
#define R8_UART0_RBR                                                           \
  (*((PUINT8V)0x40003008)) // RO, UART0 receiver buffer, receiving byte
#define R8_UART0_THR                                                           \
  (*((PUINT8V)0x40003008)) // WO, UART0 transmitter holding, transmittal byte
#define R8_UART0_RFC (*((PUINT8V)0x4000300A)) // RO, UART0 receiver FIFO count
#define R8_UART0_TFC                                                           \
  (*((PUINT8V)0x4000300B)) // RO, UART0 transmitter FIFO count
#define R32_UART0_SETUP (*((PUINT32V)0x4000300C)) // RW, UART0 setup
#define R16_UART0_DL (*((PUINT16V)0x4000300C))    // RW, UART0 divisor latch
#define R8_UART0_DLL                                                           \
  (*((PUINT8V)0x4000300C)) // RW, UART0 divisor latch LSB byte
#define R8_UART0_DLM                                                           \
  (*((PUINT8V)0x4000300D)) // RW, UART0 divisor latch MSB byte
#define R8_UART0_DIV                                                           \
  (*((PUINT8V)0x4000300E)) // RW, UART0 pre-divisor latch byte, only low 7 bit,
                           // from 1 to 0/128
#define R8_UART0_ADR                                                           \
  (*((PUINT8V)0x4000300F)) // RW, UART0 slave address: 0xFF=disable,
                           // other=enable
...
#define R8_UART1_IIR                                                           \
  (*((PUINT8V)0x40003404)) // RO, UART1 interrupt identification
...
#define R8_UART1_RBR                                                           \
  (*((PUINT8V)0x40003408)) // RO, UART1 receiver buffer, receiving byte
#define R8_UART1_THR                                                           \
  (*((PUINT8V)0x40003408)) // WO, UART1 transmitter holding, transmittal byte
#define R8_UART1_RFC (*((PUINT8V)0x4000340A)) // RO, UART1 receiver FIFO count
#define R8_UART1_TFC                                                           \
  (*((PUINT8V)0x4000340B)) // RO, UART1 transmitter FIFO count
#define R32_UART1_SETUP (*((PUINT32V)0x4000340C)) // RW, UART1 setup
#define R16_UART1_DL (*((PUINT16V)0x4000340C))    // RW, UART1 divisor latch
#define R8_UART1_DLL                                                           \
  (*((PUINT8V)0x4000340C)) // RW, UART1 divisor latch LSB byte
#define R8_UART1_DLM                                                           \
  (*((PUINT8V)0x4000340D)) // RW, UART1 divisor latch MSB byte
#define R8_UART1_DIV                                                           \
  (*((PUINT8V)0x4000340E)) // RW, UART1 pre-divisor latch byte, only low 7 bit,
                           // from 1 to 0/128
...
#define R8_UART2_IIR                                                           \
  (*((PUINT8V)0x40003804)) // RO, UART2 interrupt identification
...
#define R8_UART2_RBR                                                           \
  (*((PUINT8V)0x40003808)) // RO, UART2 receiver buffer, receiving byte
#define R8_UART2_THR                                                           \
  (*((PUINT8V)0x40003808)) // WO, UART2 transmitter holding, transmittal byte
#define R8_UART2_RFC (*((PUINT8V)0x4000380A)) // RO, UART2 receiver FIFO count
#define R8_UART2_TFC                                                           \
  (*((PUINT8V)0x4000380B)) // RO, UART2 transmitter FIFO count
#define R32_UART2_SETUP (*((PUINT32V)0x4000380C)) // RW, UART2 setup
#define R16_UART2_DL (*((PUINT16V)0x4000380C))    // RW, UART2 divisor latch
#define R8_UART2_DLL                                                           \
  (*((PUINT8V)0x4000380C)) // RW, UART2 divisor latch LSB byte
#define R8_UART2_DLM                                                           \
  (*((PUINT8V)0x4000380D)) // RW, UART2 divisor latch MSB byte
#define R8_UART2_DIV                                                           \
  (*((PUINT8V)0x4000380E)) // RW, UART2 pre-divisor latch byte, only low 7 bit,
                           // from 1 to 0/128
...
#define R8_UART3_IIR                                                           \
  (*((PUINT8V)0x40003C04)) // RO, UART3 interrupt identification
...
#define R8_UART3_RBR                                                           \
  (*((PUINT8V)0x40003C08)) // RO, UART3 receiver buffer, receiving byte
#define R8_UART3_THR                                                           \
  (*((PUINT8V)0x40003C08)) // WO, UART3 transmitter holding, transmittal byte
#define R8_UART3_RFC (*((PUINT8V)0x40003C0A)) // RO, UART3 receiver FIFO count
#define R8_UART3_TFC                                                           \
  (*((PUINT8V)0x40003C0B)) // RO, UART3 transmitter FIFO count
#define R32_UART3_SETUP (*((PUINT32V)0x40003C0C)) // RW, UART3 setup
#define R16_UART3_DL (*((PUINT16V)0x40003C0C))    // RW, UART3 divisor latch
#define R8_UART3_DLL                                                           \
  (*((PUINT8V)0x40003C0C)) // RW, UART3 divisor latch LSB byte
#define R8_UART3_DLM                                                           \
  (*((PUINT8V)0x40003C0D)) // RW, UART3 divisor latch MSB byte
#define R8_UART3_DIV                                                           \
  (*((PUINT8V)0x40003C0E)) // RW, UART3 pre-divisor latch byte, only low 7 bit,
                           // from 1 to 0/128
...
// #define  RB_MSR_RI_CHG      0x04                      // RZ, UART0 RI changed
// status, high action #define  RB_MSR_DCD_CHG     0x08                      //
...
// #define  RB_MSR_RI          0x40                      // RO, UART0 RI action
// status #define  RB_MSR_DCD         0x80                      // RO, UART0 DCD
// action status
#define UART_RBR 8
#define UART_THR 8
...
#define R8_SPI0_CLOCK_DIV                                                      \
  (*((PUINT8V)0x40004003)) // RW, SPI0 master clock divisor
#define R8_SPI0_SLAVE_PRE                                                      \
  (*((PUINT8V)0x40004003))                        // RW, SPI0 slave preset value
...
#define R8_SPI0_FIFO_COUNT                                                     \
  (*((PUINT8V)0x40004007)) // RO, SPI0 FIFO count status
#define R32_SPI0_TOTAL_CNT                                                     \
  (*((PUINT32V)0x4000400C)) // RW, SPI0 total byte count, only low 12 bit
#define R16_SPI0_TOTAL_CNT                                                     \
  (*((PUINT16V)0x4000400C)) // RW, SPI0 total byte count, only low 12 bit
...
#define R8_SPI0_FIFO_COUNT1                                                    \
  (*((PUINT8V)0x40004013)) // RO, SPI0 FIFO count status
#define R32_SPI0_DMA_NOW                                                       \
  (*((PUINT32V)0x40004014)) // RW, SPI0 DMA current address
#define R16_SPI0_DMA_NOW                                                       \
  (*((PUINT16V)0x40004014)) // RW, SPI0 DMA current address
...
#define R8_SPI1_CTRL_CFG                                                       \
  (*((PUINT8V)0x40004401)) // RW, SPI1 configuration control
#define R8_SPI1_INTER_EN (*((PUINT8V)0x40004402)) // RW, SPI1 interrupt enable
#define R8_SPI1_CLOCK_DIV                                                      \
  (*((PUINT8V)0x40004403)) // RW, SPI1 master clock divisor
...
#define R8_SPI1_FIFO_COUNT                                                     \
  (*((PUINT8V)0x40004407)) // RO, SPI1 FIFO count status
#define R32_SPI1_TOTAL_CNT                                                     \
  (*((PUINT32V)0x4000440C)) // RW, SPI1 total byte count, only low 12 bit
#define R16_SPI1_TOTAL_CNT                                                     \
  (*((PUINT16V)0x4000440C)) // RW, SPI1 total byte count, only low 12 bit
...
#define R8_SPI1_FIFO_COUNT1                                                    \
  (*((PUINT8V)0x40004413)) // RO, SPI1 FIFO count status
...
#define RB_SPI1_SDI_OE                                                         \
  0x80 // RW, SPI1 SDI output enable, SPI1 enable 2 wire mode:
       // 0=3wire(SCK1,SDO,SDI), 1=2wire(SCK1,SDI=SDX)
...
#define RB_SPI_IE_FST_BYTE                                                     \
  0x80 // RW, enable interrupt for SPI0 slave mode first byte received
...
#define RB_SPI_IF_FST_BYTE                                                     \
  0x80 // RW1, interrupt flag for SPI0 slave mode first byte received
...
#define R8_I2C_PEC                                                             \
  (*((PUINT8V)0x40004819)) // R0, I2C Packet error checking register
...
#define RB_PWM4_POLAR                                                          \
  0x01 // RW, PWM4 output polarity: 0=default low and high action, 1=default
       // high and low action
#define RB_PWM5_POLAR                                                          \
  0x02 // RW, PWM5 output polarity: 0=default low and high action, 1=default
       // high and low action
#define RB_PWM6_POLAR                                                          \
  0x04 // RW, PWM6 output polarity: 0=default low and high action, 1=default
       // high and low action
#define RB_PWM7_POLAR                                                          \
  0x08 // RW, PWM7 output polarity: 0=default low and high action, 1=default
       // high and low action
#define RB_PWM8_POLAR                                                          \
  0x10 // RW, PWM8 output polarity: 0=default low and high action, 1=default
       // high and low action
#define RB_PWM9_POLAR                                                          \
  0x20 // RW, PWM9 output polarity: 0=default low and high action, 1=default
       // high and low action
#define RB_PWM10_POLAR                                                         \
  0x40 // RW, PWM10 output polarity: 0=default low and high action, 1=default
       // high and low action
#define RB_PWM11_POLAR                                                         \
  0x80 // RW, PWM11 output polarity: 0=default low and high action, 1=default
       // high and low action
#define PWM_CONFIG 2
...
#define RB_PWM_CYC_MOD                                                         \
  0x0C // RW, PWM data width mode: 00=8 bits data, 01=7 bits data, 10=6 bits
       // data, 11=5 bits data
#define RB_PWM4_5_STAG_EN                                                      \
  0x10 // RW, PWM4/5 stagger output enable: 0=independent output, 1=stagger
       // output
#define RB_PWM6_7_STAG_EN                                                      \
  0x20 // RW, PWM6/7 stagger output enable: 0=independent output, 1=stagger
       // output
#define RB_PWM8_9_STAG_EN                                                      \
  0x40 // RW, PWM8/9 stagger output enable: 0=independent output, 1=stagger
       // output
#define RB_PWM10_11_STAG_EN                                                    \
  0x80 // RW, PWM10/11 stagger output enable: 0=independent output, 1=stagger
       // output
...
#define BOOT_LOAD_CFG                                                          \
  0x7E000 // start address of configuration information for boot loader program
...
#define INT_ADDR_TMR0                                                          \
  (INT_ID_TMR0 * INT_VEC_ENTRY_SZ) // interrupt vector address for Timer0
#define INT_ADDR_GPIO_A                                                        \
  (INT_ID_GPIO_A * INT_VEC_ENTRY_SZ) // interrupt vector address for GPIO port A
#define INT_ADDR_GPIO_B                                                        \
  (INT_ID_GPIO_B * INT_VEC_ENTRY_SZ) // interrupt vector address for GPIO port B
#define INT_ADDR_SPI0                                                          \
  (INT_ID_SPI0 * INT_VEC_ENTRY_SZ) // interrupt vector address for SPI0
#define INT_ADDR_BLEB                                                          \
  (INT_ID_BLEB * INT_VEC_ENTRY_SZ) // interrupt vector address for BLEBB
#define INT_ADDR_BLEL                                                          \
  (INT_ID_BLEL * INT_VEC_ENTRY_SZ) // interrupt vector address for BLELLE
#define INT_ADDR_USB                                                           \
  (INT_ID_USB * INT_VEC_ENTRY_SZ) // interrupt vector address for USB
#define INT_ADDR_USB2                                                          \
  (INT_ID_USB2 * INT_VEC_ENTRY_SZ) // interrupt vector address for USB2
#define INT_ADDR_TMR1                                                          \
  (INT_ID_TMR1 * INT_VEC_ENTRY_SZ) // interrupt vector address for Timer1
#define INT_ADDR_TMR2                                                          \
  (INT_ID_TMR2 * INT_VEC_ENTRY_SZ) // interrupt vector address for Timer2
#define INT_ADDR_UART0                                                         \
  (INT_ID_UART0 * INT_VEC_ENTRY_SZ) // interrupt vector address for UART0
#define INT_ADDR_UART1                                                         \
  (INT_ID_UART1 * INT_VEC_ENTRY_SZ) // interrupt vector address for UART1
#define INT_ADDR_RTC                                                           \
  (INT_ID_RTC * INT_VEC_ENTRY_SZ) // interrupt vector address for RTC
#define INT_ADDR_ADC                                                           \
  (INT_ID_ADC *                                                                \
   INT_VEC_ENTRY_SZ) // interrupt vector address for ADC and TouchKey
#define INT_ADDR_I2C                                                           \
  (INT_ID_I2C * INT_VEC_ENTRY_SZ) // interrupt vector address for I2C
#define INT_ADDR_PWMX_SPI1                                                     \
  (INT_ID_PWMX_SPI1 *                                                          \
   INT_VEC_ENTRY_SZ) // interrupt vector address for PWM4~11 and SPI1
#define INT_ADDR_TMR3                                                          \
  (INT_ID_TMR3 * INT_VEC_ENTRY_SZ) // interrupt vector address for Timer3
#define INT_ADDR_UART2                                                         \
  (INT_ID_UART2 * INT_VEC_ENTRY_SZ) // interrupt vector address for UART2
#define INT_ADDR_UART3                                                         \
  (INT_ID_UART3 * INT_VEC_ENTRY_SZ) // interrupt vector address for UART3
#define INT_ADDR_WDOG_BAT                                                      \
  (INT_ID_WDOG_BAT * INT_VEC_ENTRY_SZ) // interrupt vector address for Watch-Dog
                                       // timer and Battery low voltage
...
/*      USB2  */
#define R32_USB2_CONTROL                                                       \
  (*((PUINT32V)0x40008400)) // USB2 control & interrupt enable & device address
#define R8_USB2_CTRL (*((PUINT8V)0x40008400)) // USB2 base control
#define R8_U2DEV_CTRL                                                          \
  (*((PUINT8V)0x40008401))           // USB2 device physical prot control
...
#define R32_USB2_STATUS                                                        \
  (*((PUINT32V)0x40008404)) // USB2 miscellaneous status & interrupt flag &
                            // interrupt status
...
#define R16_U2EP0_DMA                                                          \
  (*((PUINT16V)0x40008410)) // USB2 endpoint 0 DMA buffer address
#define R16_U2EP1_DMA                                                          \
  (*((PUINT16V)0x40008414)) // USB2 endpoint 1 DMA buffer address
#define R16_U2EP2_DMA                                                          \
  (*((PUINT16V)0x40008418))          // USB2 endpoint 2 DMA buffer address
#define R16_U2H_RX_DMA R16_U2EP2_DMA // USB2 host rx endpoint buffer address
#define R16_U2EP3_DMA                                                          \
  (*((PUINT16V)0x4000841C))          // USB2 endpoint 3 DMA buffer address
#define R16_U2H_TX_DMA R16_U2EP3_DMA // USB2 host tx endpoint buffer address
#define R16_U2EP5_DMA                                                          \
  (*((PUINT16V)0x40008454)) // USB2 endpoint 5 DMA buffer address
#define R16_U2EP6_DMA                                                          \
  (*((PUINT16V)0x40008458)) // USB2 endpoint 6 DMA buffer address
#define R16_U2EP7_DMA                                                          \
  (*((PUINT16V)0x4000845C)) // USB2 endpoint 7 DMA buffer address
#define R32_USB2_EP0_CTRL                                                      \
  (*((PUINT32V)0x40008420)) // USB2 endpoint 0 control & transmittal length
#define R8_U2EP0_T_LEN                                                         \
  (*((PUINT8V)0x40008420)) // USB2 endpoint 0 transmittal length
#define R8_U2EP0_CTRL (*((PUINT8V)0x40008422)) // USB2 endpoint 0 control
#define R32_USB2_EP1_CTRL                                                      \
  (*((PUINT32V)0x40008424)) // USB2 endpoint 1 control & transmittal length
#define R8_U2EP1_T_LEN                                                         \
  (*((PUINT8V)0x40008424)) // USB2 endpoint 1 transmittal length
#define R8_U2EP1_CTRL (*((PUINT8V)0x40008426)) // USB2 endpoint 1 control
#define R8_U2H_SETUP R8_U2EP1_CTRL             // USB2 host aux setup
#define R32_USB2_EP2_CTRL                                                      \
  (*((PUINT32V)0x40008428)) // USB2 endpoint 2 control & transmittal length
#define R8_U2EP2_T_LEN                                                         \
  (*((PUINT8V)0x40008428)) // USB2 endpoint 2 transmittal length
...
#define R32_USB2_EP3_CTRL                                                      \
  (*((PUINT32V)0x4000842c)) // USB2 endpoint 3 control & transmittal length
#define R8_U2EP3_T_LEN                                                         \
  (*((PUINT8V)0x4000842c)) // USB2 endpoint 3 transmittal length
#define R8_U2EP3_CTRL (*((PUINT8V)0x4000842e)) // USB2 endpoint 3 control
#define R8_U2H_TX_LEN                                                          \
  R8_U2EP3_T_LEN // USB2 host transmittal endpoint transmittal length
#define R8_U2H_TX_CTRL R8_U2EP3_CTRL // USB2 host transmittal endpoint control
#define R32_USB2_EP4_CTRL                                                      \
  (*((PUINT32V)0x40008430)) // USB2 endpoint 4 control & transmittal length
#define R8_U2EP4_T_LEN                                                         \
  (*((PUINT8V)0x40008430)) // USB2 endpoint 4 transmittal length
#define R8_U2EP4_CTRL (*((PUINT8V)0x40008432)) // USB2 endpoint 4 control
#define R32_USB2_EP5_CTRL                                                      \
  (*((PUINT32V)0x40008464)) // USB2 endpoint 5 control & transmittal length
#define R8_U2EP5_T_LEN                                                         \
  (*((PUINT8V)0x40008464)) // USB2 endpoint 5 transmittal length
#define R8_U2EP5_CTRL (*((PUINT8V)0x40008466)) // USB2 endpoint 5 control
#define R32_USB2_EP6_CTRL                                                      \
  (*((PUINT32V)0x40008468)) // USB2 endpoint 6 control & transmittal length
#define R8_U2EP6_T_LEN                                                         \
  (*((PUINT8V)0x40008468)) // USB2 endpoint 6 transmittal length
#define R8_U2EP6_CTRL (*((PUINT8V)0x4000846A)) // USB2 endpoint 6 control
#define R32_USB2_EP7_CTRL                                                      \
  (*((PUINT32V)0x4000846C)) // USB2 endpoint 7 control & transmittal length
#define R8_U2EP7_T_LEN                                                         \
  (*((PUINT8V)0x4000846C)) // USB2 endpoint 7 transmittal length
